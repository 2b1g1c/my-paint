...
void APIENTRY glDebugOutput( std::uint32_t source, std::uint32_t type, std::uint32_t id, std::uint32_t severity,
...
mr::Window* mr::Application::create_window(int width, int height, std::string_view handle) {
